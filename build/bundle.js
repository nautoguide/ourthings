...
function () {
  ...
  _createClass(Queue, [{
    ...
    value: function templateProcessor(templateId, targetId) {
      ...
      var pharsedTemplate = self.templatePharse(templateHTML);
    ...
    key: "templatePharse",
    value: function templatePharse(template) {
      var commandRegex = /[@\-](.*?\);)/;
      var match = undefined;
      var commands = [];
      var parentCommand;
