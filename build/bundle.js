...
/***/ "./src/ourthings/internals/api.js":
/*!****************************************!*\
  !*** ./src/ourthings/internals/api.js ***!
  \****************************************/
/*! exports provided: default */
...
function (_Queueable) {
  ...
  _createClass(Api, [{
    ...
    value: function get(pid, json) {
      ...
      fetch(json.url, {
        ...
        return self.queue.handleFetchErrors(response);
      }).then(function (response) {
  ...
  return Api;
}(_queueable__WEBPACK_IMPORTED_MODULE_0__["default"]);



/***/ }),

/***/ "./src/ourthings/internals/elements.js":
/*!*********************************************!*\
  !*** ./src/ourthings/internals/elements.js ***!
  \*********************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_Queueable) {
  _inherits(Elements, _Queueable);

  function Elements() {
    _classCallCheck(this, Elements);

    return _possibleConstructorReturn(this, _getPrototypeOf(Elements).apply(this, arguments));
  }
  ...
  _createClass(Elements, [{
     ...
     * @param json
     */
    value: function addClass(pid, json) {
      var self = this;
      var element = self.queue.getElement(json.targetId);
      self.set(pid, json);
...
/***/ "./src/ourthings/internals/templates.js":
/*!**********************************************!*\
  !*** ./src/ourthings/internals/templates.js ***!
  \**********************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_Queueable) {
  _inherits(Templates, _Queueable);
  ...
  _createClass(Templates, [{
     ...
     * @param json
     */
    value: function render(pid, json) {
      var self = this;
      self.set(pid, json);
      if (!self.queue.templateProcessor(json.template, json.targetId)) self.finished(pid, self.queue.DEFINE.FIN_ERROR, 'Could not render template');else self.finished(pid, self.queue.DEFINE.FIN_OK);
    }
  }]);
...
/* harmony import */ var _internals_templates_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./internals/templates.js */ "./src/ourthings/internals/templates.js");
/* harmony import */ var _internals_elements_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./internals/elements.js */ "./src/ourthings/internals/elements.js");
/* harmony import */ var _internals_api_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./internals/api.js */ "./src/ourthings/internals/api.js");
...
window.onload = function () {
  ...
  window.queueables['templates'] = new _internals_templates_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  window.queueables['elements'] = new _internals_elements_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  window.queueables['api'] = new _internals_api_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  queue = new _queue_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
  /**
...
function () {
  ...
  function Queue() {
    ...
    for (var i in window.queueables) {
    ...
    fetch('templates.json', {
      ...
      return self.handleFetchErrors(response);
    }).then(function (response) {
      return response.json();
    }).then(function (response) {
      /**
  ...
  _createClass(Queue, [{
    ...
    value: function templateLoader() {
      ...
      if (this.templates.length === 0) {
        document.head.appendChild(self.fragment); // Clean up the fragment
    ...
    value: function templateProcessor(templateId, targetId) {
      var self = this;
      var commands = [];
      var templateDom = self.getElement(templateId);
      ...
      var parsedTemplate = self.templateParse(templateHTML, commands);
      /*
    ...
    key: "templateVars",
    value: function templateVars(template) {
      var forRegex = /{{#for (.*?)}}([\s\S]*?){{\/for}}/;
      var match = undefined;

      while (match = forRegex.exec(template)) {
        var subTemplate = '';

        for (var i in eval(match[1])) {
          var incrementMatch = match[2].replace(/#loop0/, i);
    ...
    key: "varsParser",
    value: function varsParser(parseString) {
    ...
    key: "templateParse",
    value: function templateParse(template, commands) {
      var commandRegex = /[@\-](.*?\);)/;
      var match = undefined;
      var parentCommand;
      var isParent;
      ...
      while (match = commandRegex.exec(template)) {
        ...
        var command = self.commandParse(match[1], isParent);
        /*
    ...
    key: "commandsBind",
    value: function commandsBind(commandObj) {
      var self = this;
      ...
      var _loop = function _loop(command) {
        ...
        if (commandObj[command].options.queueRun !== self.DEFINE.COMMAND_INSTANT) {
           ...
           */
          var element = self.getElement("[data-queueable=CMD" + command + "]");
          /*
    ...
    key: "commandsQueue",
    value: function commandsQueue(commandObj) {
      var self = this;

      for (var command in commandObj) {
        if (commandObj[command].options.queueRun === self.DEFINE.COMMAND_INSTANT) {
          var dereference = self.deepCopy(commandObj[command]);
    ...
    key: "findQueueByPid",
    value: function findQueueByPid(pid) {
      for (var item in self.queue) {
    ...
    key: "memory",
    value: function memory(pid, value, name) {
      var self = this;
      var command = this.findQueueByPid(pid);

      if (command) {
        var origin = name || command.queueable + '.' + command.command;
        var mode = self.DEFINE.MEMORY_GARBAGE;
        if (command.options.memory) mode = command.options.memory;
        var memoryDetails = {
          pid: pid,
          mode: mode,
          origin: origin,
    ...
    key: "cleanMemory",
    value: function cleanMemory(pid) {
      var self = this;

      for (var i in window.memory) {
    ...
    key: "finished",
    value: function finished(pid, mode, error) {
      var self = this;
    ...
    key: "commandParse",
    value: function commandParse(command, isParent) {
      var self = this;
      var commandObject = {}; // Find the actual command

      var commandArray = command.match(/(.*?)\(/)[1].split('.');
      commandObject.queueable = commandArray[0];
      commandObject.command = commandArray[1]; // Strip as we go to make follow up regex easier

      command = command.replace(/.*?\(/, ''); // Find first json arg

      var json = command.match(/(\{.*?\})/);
    ...
    key: "renderToDom",
    value: function renderToDom(domObject, text, mode) {
      var self = this;
    ...
    key: "getElement",
    value: function getElement(elementTarget) {
      var self = this;
      var element = document.querySelector(elementTarget);
    ...
    value: function show() {
      ...
      for (var i in self.queue) {
        ...
        for (var j in self.queue[i].commands) {
          indent++;
    ...
    key: "prettyCommandObject",
    value: function prettyCommandObject(commandObject, indent) {
      var string = '';
      ...
      var color = self.DEFINE.CONSOLE_COL_GREEN;
      ...
      if (commandObject.error) console.log('%c  Stopped: ' + commandObject.error, self.DEFINE.CONSOLE_COL_AMBER);
    }
    /**
    ...
    key: "reportError",
    value: function reportError(error, message) {
      console.info(self.DEFINE.CONSOLE_LINE);
      console.error('Error:', error);
    ...
    key: "deepCopy",
    value: function deepCopy(inputObject) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Queueable; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
   ...
   */
  function Queueable() {
    _classCallCheck(this, Queueable);
  ...
  _createClass(Queueable, [{
    ...
    key: "start",
    value: function start(pid, command, json) {
      var self = this;
    ...
    key: "finished",
    value: function finished(pid, mode) {
    ...
    key: "set",
    value: function set(pid, value, name) {
      var self = this;
